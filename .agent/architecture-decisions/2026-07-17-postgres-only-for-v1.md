...
**Chỉ xem xét lại khi có một trigger cụ thể:** nếu `provisionTree` / `referenceProvisions` của vbpl hóa ra được điền dữ liệu trên toàn trang, thì đó là một đồ thị pháp lý ở cấp điều khoản (điều/khoản) trên ~158.826 văn bản với 27 quan hệ hai chiều có kiểu — một tài sản thực sự mang hình dạng đồ thị, và đáng để mở lại quyết định này. **Đo lại 2026-07-18 (TASK-004): trigger CHƯA kích hoạt.** Lấy mẫu 21 văn bản đã công bố — `provisionTree` và `referenceProvisions` = `null` trên 21/21; **cạnh trích dẫn cấp điều khoản (tài sản mang hình dạng đồ thị) không tồn tại.** Có một cây điều khoản Chương→Điều→Khoản→Điểm qua một Server Action khác, nhưng đó là *cấu trúc phân cấp bên trong một văn bản* (một cây, không phải đồ thị liên-văn-bản) — vẫn là một bảng với khóa cha, không phải lý do cho Neo4j. **Quyết định Postgres-only đứng vững.** Xem [research/task-004-vbpl-provisiontree](../../research/task-004-vbpl-provisiontree/README.md), [Nguồn Dữ liệu](../concepts/data-sources.md) và Các câu hỏi mở trong [Bối cảnh Dự án](../project-context.md#câu-hỏi-mở).
...
- **Đồ thị cấp điều khoản của vbpl — ĐO 2026-07-18 (TASK-004): trigger Neo4j CHƯA kích hoạt.** `provisionTree` và `referenceProvisions` = `null` trên 21/21 văn bản đã lấy mẫu; cạnh trích dẫn cấp điều khoản không tồn tại. Cây điều khoản (cấu trúc phân cấp bên trong một văn bản) thì CÓ qua một Server Action khác, nhưng là một cây, không phải đồ thị liên-văn-bản — không đổi kết luận. Quyết định Postgres-only đứng vững. Xem [research/task-004-vbpl-provisiontree](../../research/task-004-vbpl-provisiontree/README.md).
