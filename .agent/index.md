...
- [Dòng 8 số mô hình chọn, in dưới nhóm ứng viên](architecture-decisions/2026-09-22-hs-line-under-candidate.md) — `tariff_ref` là lựa chọn trong LINES, code kiểm và in `↳ mã · câu chữ`; khối thuế `full` tra dòng đã chọn thay dòng đầu
