...
**Hậu quả của việc phá vỡ nó.** Một mức thuế sai đi một lượng nghe hợp lý là vô hình với người dùng, vô hình khi rà soát, và có ràng buộc pháp lý một khi đã khai. Người khai phải nộp đủ số thuế thiếu, bị phạt và nộp tiền chậm nộp (NĐ 169/2026/NĐ-CP không nêu mức tiền chậm nộp). Xem [R3](#r3--error-but-valid-là-chế-độ-thất-bại-đặc-trưng) để biết biểu chi tiết.
...
**Hậu quả của việc phá vỡ nó — biểu chi tiết mức phạt.** Nghị định 169/2026/NĐ-CP, hiệu lực 01/07/2026; từ ngày đó Nghị định 128/2020/NĐ-CP và Điều 2 Nghị định 102/2021/NĐ-CP hết hiệu lực (khoản 2 Điều 38). Vi phạm xảy ra và kết thúc trước 01/07/2026: áp dụng NĐ 169/2026 nếu nó không quy định trách nhiệm pháp lý hoặc quy định nhẹ hơn (khoản 1 Điều 39). (đã đối chiếu 2026-09-15, nguồn: Công báo số 293 ngày 31/05/2026, https://congbao.chinhphu.vn/van-ban/nghi-dinh-so-169-2026-nd-cp-469561.htm):
...
Ngoài ra: xử phạt theo Điều 10 chỉ áp dụng khi số tiền thuế chênh lệch **từ 500.000 đồng/tờ khai (cá nhân) / 2.000.000 đồng/tờ khai (tổ chức)** (Điều 10 khoản 6); vi phạm khai hải quan tại Điều 9 mà tự phát hiện và khai bổ sung quá hạn bị phạt theo khung riêng của Điều 9 khoản 6 (vd. 500.000–1.000.000 đồng cho khoản 1) — không áp cho sai HS vì Điều 9 không còn hành vi đó; **thời hiệu 05 năm** cho trốn thuế và khai sai dẫn đến thiếu thuế, **02 năm** cho vi phạm hải quan khác; quá thời hiệu vẫn phải nộp đủ thuế, tiền chậm nộp **trong thời hạn 10 năm trở về trước, kể từ ngày phát hiện** (Điều 5 khoản 1, 2) (cùng nguồn).

**Lưu ý sự bất đối xứng định hình sản phẩm:** tự phát hiện là 10%, hải quan phát hiện là 20%, và một dấu vết giấy tờ xấu là 100–300% (NĐ 169/2026/NĐ-CP Điều 10 khoản 2, 3; Điều 15 khoản 2). Giá trị của sản phẩm nằm không cân xứng ở việc *tìm ra lỗi trước khi hải quan tìm ra* — đó là lý do vì sao kiểm toán tính nhất quán (đánh dấu nơi các tờ khai lịch sử của chính một công ty dùng mã khác nhau cho cùng một hàng hóa) là một tính năng hạng nhất, không phải một thứ có-thì-tốt.
...
- Tìm các công văn / thông báo xác định trước mã số của Việt Nam trước đó cho hàng hóa tương tự — hiện gần như bất khả thi thủ công vì kho văn bản không được index. Từ 15/09/2026 Cục Hải quan phải công khai các thông báo này (khoản 5 Điều 13, khoản 3 Điều 14 TT 85/2026/TT-BTC); chưa kiểm trang đó có tra cứu, tải hàng loạt được không.
...
- **customs.gov.vn** — `robots.txt` trả về `User-agent: *` **mà không có dòng `Disallow` nào cả**; không có gì bị loại trừ (không sitemap; `/sitemap.xml` → 404). Crawl được phép, nhưng nó **không có thẩm quyền pháp lý — Nghị định mới có**. Endpoint 'bridge' của API đã được xác nhận hoạt động (quan sát trực tiếp trên trình duyệt, tab Network, 2026-07-18) và vẫn chỉ là một tầng đối chiếu chéo tiện lợi, không phải nguồn chân lý. Xem [Xung đột — §1 (đã giải quyết)](#xung-đột-chưa-giải-quyết).
...
- **Không có tương đương CROSS/EBTI nào tồn tại tại Việt Nam.** Không có một kho phán quyết phân loại sạch, đầy đủ, máy-đọc-được, có thể truy vấn công khai nào tương đương với US CBP CROSS hay EU EBTI. Các Thông báo kết quả phân loại về cơ bản là nội bộ (được đẩy vào **Customslab**, tìm kiếm được bởi các đơn vị hải quan, không phải công chúng); từ 15/09/2026 Thông báo kết quả phân tích, phân loại được công khai trên trang thông tin điện tử của Cục Hải quan, trừ phần phụ lục (khoản 6 Điều 12 TT 85/2026/TT-BTC); khối lượng nhỏ (~2.500 mẫu được xử lý; nửa đầu 2026 → **257 hồ sơ nhận, 143 thông báo phân loại được ban hành**). **Điều này giới hạn chất lượng truy hồi bởi khả năng tiếp cận dữ liệu, không phải bởi năng lực mô hình** — hãy nêu giới hạn đó với người dùng thay vì che đậy nó. (đã xác minh 2026-07-17, nguồn: research 09 §3 · https://thuehaiquan.tapchikinhtetaichinh.vn/hai-quan-xu-ly-gan-2-500-mam-phan-tich-phan-loai-hang-hoa-xuat-nhap-khau-160924.html)

---

## Xung đột chưa giải quyết

### 1. API customs.gov.vn — research 10 vs research 12. **ĐÃ GIẢI QUYẾT (2026-07-18).**

Hai agent nghiên cứu đi tới các kết luận khác nhau về bản chất cho cùng một hệ thống trong cùng một ngày. **Đã giải quyết 2026-07-18.** Chủ dự án **quan sát trực tiếp trên trình duyệt (tab Network của devtools)** rằng cổng tra cứu biểu thuế customs.gov.vn **gọi endpoint 'bridge'** (`POST https://www.customs.gov.vn/bridge?url=/customs/servletws/bieuthue/APIBieuThue`) và **nhận dữ liệu trả về**. Quan sát này **bác bỏ** giả thuyết của research 12 rằng cổng là một vỏ JS chết mà backend duy nhất là IP thô `123.30.210.236:8080` (đã hết thời gian chờ), và **xác nhận** research 10 rằng 'bridge' là endpoint sống. Hai báo cáo mô tả **hai endpoint khác nhau** — cả hai đều có thể đúng — nhưng với dự án này, backend IP thô **cố ý không được theo đuổi**. Quyết định của chủ dự án: **dùng 'bridge'; không theo đuổi backend IP thô.** Lưu ý trung thực: đây là một **quan sát trên tab Network của trình duyệt**, *không phải* một lần tái lập bằng `curl` thuần, và **chưa bắt được mẫu phản hồi**; ba hạng mục chấp nhận còn lại của TASK-002 **vẫn cần làm** (không chặn thiết kế): tái lập bằng `curl` thuần từ mạng công ty, bắt một mẫu phản hồi cho một mã HS đã biết để đối chiếu với bộ phận khai báo, và thăm dò giới hạn tốc độ. Trạng thái của API **không đổi**: nó vẫn là một **tầng đối chiếu chéo tiện lợi, KHÔNG phải nguồn chân lý pháp lý** — không quyết định thiết kế nào phụ thuộc vào 'bridge'; đường đi Công báo `.doc` vẫn là đường chịu lực.
...
**Xung đột là gì.** Đây **khả dĩ là hai endpoint khác nhau** — 10 tìm thấy một path bridge/proxy cùng-origin (`www.customs.gov.vn/bridge?url=…/APIBieuThue`); 12 tìm thấy một backend IP-thô hardcode trong `main.js` (`http://123.30.210.236:8080/hqcustomsapi/`). Điều đó sẽ hòa giải "không captcha" (10, path bridge) với "CheckCaptcha tồn tại" (12, path IP-thô). **Quan sát trực tiếp trên trình duyệt (tab Network) ngày 2026-07-18 đã xác nhận cách đọc hai-endpoint này:** 'bridge' cùng-origin thực sự được gọi và trả dữ liệu, nên nó là endpoint sống của dự án; backend IP-thô của 12 là một mặt tiền khác, **cố ý không được theo đuổi**, nên câu hỏi captcha trên path IP-thô không còn liên quan đến thiết kế. **Đã giải quyết** — còn tái lập bằng `curl` thuần và bắt mẫu phản hồi vẫn là việc cần làm (không chặn thiết kế; xem §1 ở trên).
...
**Chỉ thị thiết kế.** Xây trên Công báo. API 'bridge' nay đã được xác nhận hoạt động (quan sát trình duyệt 2026-07-18), nên nó là một **đối chiếu chéo** — một ý kiến thứ hai đánh dấu bất đồng cho một con người — **không bao giờ là nguồn của một mức thuế được hiển thị.**
...
- **Thông tư 85/2026/TT-BTC** (ký 30/06/2026, hiệu lực **15/09/2026**) quy định phân loại hàng hóa, phân tích để phân loại hàng hóa xuất khẩu, nhập khẩu, xây dựng và sử dụng cơ sở dữ liệu về Danh mục; thay thế TT 14/2015/TT-BTC và TT 17/2021/TT-BTC (khoản 1 Điều 15) — **quy trình** phân loại, không phải danh mục. Chuyển tiếp: mẫu đã lấy mà đến 15/09/2026 chưa có kết quả thực hiện theo văn bản có hiệu lực tại thời điểm đăng ký tờ khai (khoản 1 Điều 16); máy liên hợp, tổ hợp máy Chương 84, 85, 90 theo Danh mục đăng ký trước 15/09/2026 tiếp tục theo TT 14/2015 đến khi nhập hết (khoản 2 Điều 16). TT 14/2015 còn điều chỉnh "phân tích để kiểm tra chất lượng, kiểm tra an toàn thực phẩm"; phạm vi TT 85/2026 không nêu nội dung này (khoản 1 Điều 1). (đã đối chiếu 2026-09-15, nguồn: Công báo số 409 ngày 18/07/2026, https://congbao.chinhphu.vn/van-ban/thong-tu-so-85-2026-tt-btc-469982.htm)
