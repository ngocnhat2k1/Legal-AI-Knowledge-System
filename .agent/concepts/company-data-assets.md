...
- **Xuất xứ ≠ nước người bán — 36 dòng:** người XK Baosteel Singapore / Bossard Malaysia / Webcontrol Đài Loan nhưng *Nước xuất xứ* là CN/DE. → đọc `origin` theo dòng.
...
- **Đã bóc xong 117 tờ (2026-07-18): 259 dòng, cross-check 249/249 khớp.** Còn LẠI chưa làm: (a) chấm mẫu tay vài tờ đọc lại để bắt lỗi bóc còn sót; (b) cờ `confidence` toàn bộ đang `unmarked` — chờ bộ phận khai báo xác nhận đúng/không chắc (không được tự quyết).
