...
- **Chờ chủ dự án duyệt:** bảng nước thành viên `db/seed/data/fta-members.json` (`verifiedBy: null`, chưa code nào đọc) — [phiếu đối chiếu](../reviews/2026-09-13-fta-members-verification.md).
