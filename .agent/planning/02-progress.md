...
| **Việc tiếp theo** | (1) Chủ dự án chat thử câu pháp lý trên Zalo: hiệu lực văn bản, văn bản liệt kê một mã HS, chú giải HS. (2) Mảng 3 đầy đủ của [kế hoạch 05](05-bot-parity-tasks.md): `POST /answer`. |
